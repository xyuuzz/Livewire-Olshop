<div>
        ...
        <div class="col">
            <nav aria-label="breadcrumb ml-4 mr-4">
                <ol class="breadcrumb bg-light">
                  ...
                  <li class="breadcrumb-item {{route("product") ? "font-weight-bold" : ""}}" aria-current="page">Liga</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="row mt-3 justify-content-center">
        @forelse ($liga_product as $item_product)
            <div class="col-md-4">
                <div class="card shadow rounded-2 mt-3">
                    <div class="card-body text-center">
                        ...
                        <div class="row mt-2">
                            <div class="col">
                                <a  href="#" class="btn btn-secondary btn-sm d-block btn-block">Detail</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    {{-- {{$liga_product->links("pagination::bootstrap-4")}} --}}
